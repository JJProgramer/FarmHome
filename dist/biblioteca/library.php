...
<body>
    ...
    <script type="text/javascript">
        ...
        document.addEventListener("DOMContentLoaded", function() {
            var imagenes = document.querySelectorAll(".imagen-clickable");

            imagenes.forEach(function(imagen) {
                imagen.addEventListener("click", function() {
                    // Encuentra el elemento con la clase "pltInfo" relacionado utilizando el atributo data-target
                    var targetId = this.getAttribute("data-target");
                    var pltInfo = document.querySelector("." + targetId);

                    // Verifica si "pltInfo" está oculto y cambia su estilo
                    if (pltInfo.style.display === "none" || pltInfo.style.display === "") {
                        pltInfo.style.display = "block";
                    } else {
                        pltInfo.style.display = "none";
                    }
                });
            });
        });

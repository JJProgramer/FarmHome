...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-09-2023 a las 18:30:45
...
CREATE TABLE `municipio` (
  ...
  `mun_grado` tinyint(4) NOT NULL,
  `mun_clima` varchar(20) NOT NULL,
...
--
ALTER TABLE `region`
  ADD CONSTRAINT `region_ibfk_1` FOREIGN KEY (`mun_id`) REFERENCES `municipio` (`mun_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
